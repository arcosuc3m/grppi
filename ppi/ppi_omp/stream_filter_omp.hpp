...
inline void StreamFilter(parallel_execution_omp p, GenFunc const & in, FilterFunc const & filter, OutFunc const & out ) {
...
FilterObj<parallel_execution_omp, FilterFunc> StreamFilter(parallel_execution_omp p, FilterFunc && taskf){
