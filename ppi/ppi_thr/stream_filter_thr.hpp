...
#ifndef PPI_STREAMFILTER_THR
#define PPI_STREAMFILTER_THR

using namespace std;
namespace grppi{
template <typename GenFunc, typename FilterFunc, typename OutFunc>
inline void StreamFilter(parallel_execution_thr &p, GenFunc const & in, FilterFunc const & filter, OutFunc const & out ) {
...
FilterObj<parallel_execution_thr, FilterFunc> StreamFilter(parallel_execution_thr& p, FilterFunc && taskf){
