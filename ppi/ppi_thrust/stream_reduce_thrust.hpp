...
#ifndef PPI_STREAMREDUCE_THRUST
#define PPI_STREAMREDUCE_THRUST
...
inline void StreamReduce(parallel_execution_thrust_internal<Policy> p, GenFunc const &in, TaskFunc const &taskf, ReduceFunc const &red, OutputType &reduce_value ){
