...
inline void InternalDivideAndConquer(parallel_execution_tbb p, Input & problem, Output & output,
...
template <typename Input, typename Output, typename DivFunc, typename TaskFunc, typename MergeFunc>
inline void DivideAndConquer(parallel_execution_tbb p, Input & problem, Output & output,
