...
void farm(parallel_execution_ff & ex, Generator generate_op,
	...
	// the generator!
	//
	// TODO: Workers (i.e., consumers) take a function object by-value, and then use it as a
	// lvalue. is it better to use perfect-forwarding with function object? differences?
...
void farm(parallel_execution_ff & ex, Generator generate_op,
	...
	using consumerOutType  = typename std::result_of<Consumer(transformer_type)>::type;
