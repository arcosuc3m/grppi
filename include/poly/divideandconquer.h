...
template <typename Input, typename Output, typename DivFunc,
          typename Operation, typename MergeFunc>
void divide_and_conquer_multi_impl(polymorphic_execution & e, Input & problem, 
      Output & output, DivFunc && divide, Operation && op, MergeFunc && merge)
{
}
...
template <typename E, typename ... O,
          typename Input, typename Output, typename DivFunc,
          typename Operation, typename MergeFunc,
          internal::requires_execution_not_supported<E> = 0>
void divide_and_conquer_multi_impl(polymorphic_execution & e, Input & problem,
      Output & output, DivFunc && divide, Operation && op, MergeFunc && merge) 
{
  divide_and_conquer_multi_impl<O...>(e, problem, output, 
...
/// Runs a divide_and_conquer pattern with an initial problem, an output,
...
template <typename Input, typename Output, typename DivFunc,
          typename Operation, typename MergeFunc>
void divide_and_conquer(polymorphic_execution & e, Input & problem,
      Output & output, DivFunc && divide, Operation && op, MergeFunc && merge) 
{
